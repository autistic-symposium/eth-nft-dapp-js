export const STORYTELLER_CONTRACT = process.env
  .NEXT_PUBLIC_STORYTELLER_CONTRACT as string;
export const STORYTELLER_CONTRACT_NETWORK = process.env
  .NEXT_PUBLIC_STORYTELLER_CONTRACT_NETWORK as string;
export const STORYTELLER_CONTRACT_NETWORK_PROVIDER = process.env
  .NEXT_PUBLIC_STORYTELLER_CONTRACT_NETWORK as string;
export const NETWORK_ID = process.env.NEXT_PUBLIC_NETWORK_ID;
export const  FILMMAKER_DAO_WEBSITE = 'https://www.generativestory.com/';
...
export const SITE_URL = 'https://www.generativestory.com/';
export const ERROR_CODE_TX_REJECTED_BY_USER = 4001;

export const TOKEN_FINDER_URL = 'https://www.generativestory.com/';
...
export const STORYTELLER_CONTRACT_ABI = [
